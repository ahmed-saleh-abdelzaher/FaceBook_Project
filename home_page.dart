    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          User_Account(),
          Padding(
            padding: const EdgeInsets.only(top: 85, bottom: 25, right: 60, left: 60),
            child: Column(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        ...
                        radius: 7,
                        child: IconButton(alignment: Alignment.center,onPressed: (){},icon: Icon(Icons.add, size: 13, color: Colors.blue,),),
                      ),
                      SizedBox(width: 5,),
